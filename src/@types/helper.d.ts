 ...
 * like aria roles. The component (`C`) must be passed in.
 */
...
/**
 * A more sophisticated version of `InheritableElementProps` where the passed
...
/**
 * A wrapper of `PolymorphicComponentProps` that also includes the `ref` prop
