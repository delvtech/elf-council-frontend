    ...
    <Card className={className} variant={CardVariant.BLUE}>
      <div className="p-2 text-white sm:px-6 sm:py-4">
        ...
        <div className="mt-6 mb-6 flex flex-col gap-2 rounded-lg bg-white/10 px-5 py-4 sm:py-6 sm:px-8">
          ...
          <p>{t`An announcement will be made when the next round is claiming is ready where you'll check if your ${platformName} ID was eligible by entering your Key and Secret.`}</p>
        </div>
